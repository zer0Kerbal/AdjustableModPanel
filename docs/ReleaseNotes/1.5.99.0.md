---
perma /1.5.99.0.html
title: Release Notes v1.5.99.0
description: Version Release Notes
tags: AdjustableModPanel,release-notes,kerbal,ksp,zer0Kerbal,zedK
layout: page
---
...
[![Adjustable Mod Panel Version][MOD:shd:stat]][MOD:forum] [![KSP version][KSP:shd:stat]][KSP:url]
...
<p style="border:0.5px solid Tomato; background-color: #bada55; color: #FF0000; text-align:center">Download from <a href="https://www.curseforge.com/kerbal/ksp-mods/AdjustableModPanel/files">CurseForge</a></p>
...
* Issues
  * closes #5 - Adjustable Mod Panel 1.5.99.0-adoption `<Peekaboo>`
  * closes #6 - 1.5.99.0 Verify Legal Mumbo Jumbo
  * closes #7 - 1.5.99.0 Create Documentation
  * closes #8 - 1.5.99.0 Create Social Media
...
<p style="border:0.5px solid Tomato; background-color: lightgrey; color: #FF0000; text-align:center">Kerbal Space Program 1.12.3 — C# 10.0 — Unity 2019.2.2f1 — .NET Framework 4.7.2
</p>
...
[MOD:forum]: https://forum.kerbalspaceprogram.com/index.php?/topic/207263-* "AdjustableModPanel on the forums"
[MOD:issue]: https://github.com/zer0Kerbal/AdjustableModPanel/issues "Issue Tracker"
[MOD:known]: https://github.com/zer0Kerbal/AdjustableModPanel/wiki/Known-Issues "Known Issues"
[MOD:licns]: https://github.com/zer0Kerbal/AdjustableModPanel/blob/master/LICENSE "Repo License"
...
[MOD:shd:stat]: https://img.shields.io/badge/AdjustableModPanel%20(KAMP)%20-v1.5.99.0--adoption-BADA55.svg?style=plastic&labelColor=darkgreen "1.5.99.0-adoption"

[CRSFG:url]: https://www.curseforge.com/kerbal/ksp-mods/AdjustableModPanel/files "Curseforge"
...
[AVCVAL:shd]: https://github.com/zer0Kerbal/AdjustableModPanel/workflows/Validate%20AVC%20.version%20files/badge.svg?style=plastic&labelColor=black  
