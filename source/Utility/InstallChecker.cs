...
namespace AdjustableModPanel
{
    ...
    {
        private readonly string MODNAME = Localizer.Format("#KAMP-000"); // "Adjustable Mod Panel";
        ...
        protected void Start()
        {
            ...
            if (assemblies.Any())
            {
                ...
                (
                    ...
                    dialogName: Localizer.Format("#KAMP-IC-00"), // "Install Checker",
                    title: Localizer.Format("#KAMP-IC-00") + "\n" + Localizer.Format("#KAMP-001", Version.SText), // title: Localizer.Format("#KAMP-001" + " InstallChecker", Version.SText),
                    message: Localizer.Format("#KAMP-IC-01", Localizer.Format("#KAMP-000"), Version.SText, FOLDERNAME, String.Join("\n", badPaths.ToArray())),  // "Incorrect <<1>> v<<2>> installation.\n<<1>> has been installed incorrectly and will not function properly. All files should be located in KSP/GameData/<<3>>. Do not move any files from inside that folder.\n\nIncorrect path(s):\n<<4>>
                    buttonMessage: Localizer.Format("#autoLOC_190905"), // "Okay",
